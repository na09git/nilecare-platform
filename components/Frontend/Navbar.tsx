    ...
    <header className="fixed top-0 bg-white border-b border-gray-400/30 w-full z-50">
      ...
      >
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          ...
          <a href="/category?mode=Telehealth%20visit" className="text-sm font-semibold leading-6 text-gray-800">
            TeleHealth
          </a>
          <a href="/category?mode=In-person%20doctor%20visit" className="text-sm font-semibold leading-6 text-gray-800">
            In-Person Visit
          </a>
          <a href="/join/doctors" className="text-sm font-semibold leading-6 text-gray-800">
            Be Service Provider
          </a>
        </Popover.Group>
